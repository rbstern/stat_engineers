...
4. Se $X \in [-1,2]$ e $f_{X}(x) = cx^4$, 
determine $c$, $E[X]$ e $Var[X]$.

5. Prove que $Var[X] = E[X^2] - E[X]^2$.

6. Determine o valor de $a$ que minimiza $E[(X-a)^2]$.

7. Ache um intervalo tal que uma $N(4,9)$ 
esteja dentro deste com probabilidade aproximadamente $95\%$.

8. Se $X \sim N(4,9)$, utilize o **R** para
calcular $P(-1 \leq X  \leq 1)$.

9. Se $X \sim N(10, 100)$, indique 
uma transformação linear de $X$ que tem
distribuição normal padrão.

10. Se $X_1, \ldots, X_n$ são variáveis independentes
de mesma distribuição e tais que 
$E[X_i] = 9$ e $V[X_i] = 16$, indique valores para
$a$ e $b$ tal que 
$P(a \leq \bar{X} \leq b) \approx 95\%$.

11. Um pesquisador utilizou uma mesma medida resumo
